<?php
    ...
    $conn = new Model\Conn();
    $query = "select a.*,b.objnm as pltnm from stor_loc as a inner join plants as b on b.werks = a.werks";
    $param = array();
    ...
    <div class="card-body">
        <table id="dtbl" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td><?php echo $item->pltnm; ?> </td>
                <td><?php echo $item->lgort; ?> </td>
                <td> </td>
                <td> </td>
                <td><a href="list_aobj.php?objty=SLOC&objky=<?php echo $item->objky;?>"><img class="img-fluid rounded mx-auto d-block" style="width:25px;height:25px" src="../assets/dist/img/auth.png"></a></td>
            </tr>
            <?php 
                    } 
            ?>
