    ...
    if(!is_null($items)) {
      foreach($items as $item) {
        switch($item->cstat) {
          ...
          case 'GW' : $dash->cnt6 = $item->count;break;
        }
      }
    }
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Quality Inspection Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Quality Insp</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-6">
            ...
            <div class="small-box bg-warning ">
              ...
              <a href="../commn/list_pass.php?pstatus=QX" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-2 col-6">
            ...
            <div class="small-box bg-success ">
              ...
              <a href="../qinsp/list_pass.php?pstatus=GW" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-2 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="../commn/list_pass.php?pstatus=QR" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-2 col-6">
