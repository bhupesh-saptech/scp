                    ...
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <td colspan="2" class="text-right">
                                ...
                                <input type="hidden" name="cstat" id="cstat" value="<?php echo "{$pass->cstat}"; ?>">
                                ...
                                <button type="submit" name="action" class="btn btn-warning"   value="updtRmk" >updt Remark</button>
                                <?php } ?>
